...
class AngledIncludesPPCallbacks: public PPCallbacks {
 public:
  explicit AngledIncludesPPCallbacks(AngledIncludesCheck &Check): Check(Check) {}
  ...
  void InclusionDirective(SourceLocation HashLoc,
    ...
    for (llvm::StringRef Prefix: AngledPrefixes) {
      ...
      Check.diag(FilenameRange.getBegin(), "include of '%0' must use angle brackets")
          << FileName << FixItHint::CreateReplacement(FilenameRange, ("<" + FileName + ">").str());
      return;
    }
  }
...
void AngledIncludesCheck::registerPPCallbacks(
