...
rust_register_toolchains(
    edition = "2021",
    # Add support for macOS cross-compilation, the overhead for this is limited with only a few more
    ...
    extra_target_triples = ["x86_64-apple-darwin", "aarch64-unknown-linux-gnu"],
