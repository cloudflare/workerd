...
http_archive(
    name = "v8",
    integrity = "sha256-MJqDO68Bpl9b77cYBR70vu/PnIuX/0nmy4FlLcGX6kA=",
    patch_args = ["-p1"],
    patches = [
        ...
        "//:patches/v8/0007-Enable-V8-shared-linkage.patch",
        "//:patches/v8/0008-Randomize-the-initial-ExecutionContextId-used-by-the.patch",
        "//:patches/v8/0009-increase-visibility-of-virtual-method.patch",
        "//:patches/v8/0010-Add-ValueSerializer-SetTreatFunctionsAsHostObjects.patch",
        "//:patches/v8/0011-Set-torque-generator-path-to-external-v8.-This-allow.patch",
        "//:patches/v8/0012-Modify-where-to-look-for-fp16-dependency.-This-depen.patch",
        "//:patches/v8/0013-Expose-v8-Symbol-GetDispose.patch",
        "//:patches/v8/0014-Rename-V8_COMPRESS_POINTERS_IN_ISOLATE_CAGE-V8_COMPR.patch",
