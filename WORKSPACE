...
http_archive(
    ...
    sha256 = "e06106417ba4dea25f85c030a84025dcc70cd2ddbdc710e3a84c56187ba163d7",
    type = "zip",
    urls = ["https://github.com/dom96/pyodide_packages/releases/download/v0.9/pyodide_packages.tar.zip"],
)
