...
http_archive(
    ...
    sha256 = "dd767df4a027f50dfc3a7be3753924440c9112a68916501826ef009c546582de",
    type = "tar.bz2",
    urls = ["https://github.com/cloudflare/pyodide-build-scripts/releases/download/v6/pyodide-asm.tar.bz2"],
)
