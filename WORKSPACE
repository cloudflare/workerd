...
http_archive(
    ...
    sha256 = "4ad4007ad57af903e0a3efa01d31e3c2455890317be21bfc0caa331c66f60aed",
    type = "tar.bz2",
    urls = ["https://github.com/hoodmane/workerd-pyodide/releases/download/v3/pyodide-asm.tar.bz2"],
)
