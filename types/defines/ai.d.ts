...
export type Ai_Cf_Baai_Bge_M3_Input =
  | Ai_Cf_Baai_Bge_M3_BGE_M3_Input_QueryAnd_Contexts
  | Ai_Cf_Baai_Bge_M3_BGE_M3_Input_Embedding
  | {
      /**
       * Batch of the embeddings requests to run using async-queue
       */
      requests: (Ai_Cf_Baai_Bge_M3_BGE_M3_Input_QueryAnd_Contexts_1 | Ai_Cf_Baai_Bge_M3_BGE_M3_Input_Embedding_1)[];
    };
export interface Ai_Cf_Baai_Bge_M3_BGE_M3_Input_QueryAnd_Contexts {
  /**
...
export interface Ai_Cf_Baai_Bge_M3_BGE_M3_Input_Embedding {
  text: string | string[];
  /**
   * When provided with too long context should the model error out or truncate the context to fit?
   */
...
export interface Ai_Cf_Baai_Bge_M3_BGE_M3_Input_QueryAnd_Contexts_1 {
  /**
   * A query you wish to perform against the provided contexts. If no query is provided the model with respond with embeddings for contexts
   */
  query?: string;
...
export interface Ai_Cf_Baai_Bge_M3_BGE_M3_Input_Embedding_1 {
  text: string | string[];
  /**
   * When provided with too long context should the model error out or truncate the context to fit?
   */
...
export type Ai_Cf_Baai_Bge_M3_Output =
  | Ai_Cf_Baai_Bge_M3_BGE_M3_Ouput_Query
  | Ai_Cf_Baai_Bge_M3_BGE_M3_Output_EmbeddingFor_Contexts
  | Ai_Cf_Baai_Bge_M3_BGE_M3_Ouput_Embedding
  | Ai_Cf_Baai_Bge_M3_AsyncResponse;
export interface Ai_Cf_Baai_Bge_M3_BGE_M3_Ouput_Query {
  response?: {
    /**
...
export interface Ai_Cf_Baai_Bge_M3_BGE_M3_Output_EmbeddingFor_Contexts {
  response?: number[][];
  shape?: number[];
  /**
   * The pooling method used in the embedding process.
...
export interface Ai_Cf_Baai_Bge_M3_BGE_M3_Ouput_Embedding {
  shape?: number[];
  /**
   * Embeddings of the requested text values
   */
...
export type Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Input =
  | Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Prompt
  | Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages
  | Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Async_Batch;
export interface Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Prompt {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
export interface Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
...
export type Ai_Cf_Qwen_Qwen2_5_Coder_32B_Instruct_Input =
  | Ai_Cf_Qwen_Qwen2_5_Coder_32B_Instruct_Qwen2_5_Coder_32B_Instruct_Prompt
  | Ai_Cf_Qwen_Qwen2_5_Coder_32B_Instruct_Qwen2_5_Coder_32B_Instruct_Messages;
export interface Ai_Cf_Qwen_Qwen2_5_Coder_32B_Instruct_Qwen2_5_Coder_32B_Instruct_Prompt {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
export interface Ai_Cf_Qwen_Qwen2_5_Coder_32B_Instruct_Qwen2_5_Coder_32B_Instruct_Messages {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
...
export type Ai_Cf_Qwen_Qwq_32B_Input =
  | Ai_Cf_Qwen_Qwq_32B_Qwen_Qwq_32B_Prompt
  | Ai_Cf_Qwen_Qwq_32B_Qwen_Qwq_32B_Messages;
export interface Ai_Cf_Qwen_Qwq_32B_Qwen_Qwq_32B_Prompt {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
export interface Ai_Cf_Qwen_Qwq_32B_Qwen_Qwq_32B_Messages {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
...
export type Ai_Cf_Mistralai_Mistral_Small_3_1_24B_Instruct_Input =
  | Ai_Cf_Mistralai_Mistral_Small_3_1_24B_Instruct_Mistral_Small_3_1_24B_Instruct_Prompt
  | Ai_Cf_Mistralai_Mistral_Small_3_1_24B_Instruct_Mistral_Small_3_1_24B_Instruct_Messages;
export interface Ai_Cf_Mistralai_Mistral_Small_3_1_24B_Instruct_Mistral_Small_3_1_24B_Instruct_Prompt {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
export interface Ai_Cf_Mistralai_Mistral_Small_3_1_24B_Instruct_Mistral_Small_3_1_24B_Instruct_Messages {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
...
export type Ai_Cf_Google_Gemma_3_12B_It_Input =
  | Ai_Cf_Google_Gemma_3_12B_It_Google_Gemma_3_12B_It_Prompt
  | Ai_Cf_Google_Gemma_3_12B_It_Google_Gemma_3_12B_It_Messages;
export interface Ai_Cf_Google_Gemma_3_12B_It_Google_Gemma_3_12B_It_Prompt {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
export interface Ai_Cf_Google_Gemma_3_12B_It_Google_Gemma_3_12B_It_Messages {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
...
export type Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Input =
  | Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Ai_Cf_Meta_Llama_4_Prompt
  | Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Ai_Cf_Meta_Llama_4_Messages
  | Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Ai_Cf_Meta_Llama_4_Async_Batch;
export interface Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Ai_Cf_Meta_Llama_4_Prompt {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
export interface Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Ai_Cf_Meta_Llama_4_Messages {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
...
export interface Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Ai_Cf_Meta_Llama_4_Async_Batch {
  requests: (
    | Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Ai_Cf_Meta_Llama_4_Prompt_Inner
    | Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Ai_Cf_Meta_Llama_4_Messages_Inner
  )[];
}
export interface Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Ai_Cf_Meta_Llama_4_Prompt_Inner {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
export interface Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Ai_Cf_Meta_Llama_4_Messages_Inner {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
