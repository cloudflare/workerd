...
const helloWorldExample :Workerd.Config = (
  ...
  services = [
    ...
    (name = "service-binding", worker = .serviceBinding)
  ],
...
const helloWorld :Workerd.Worker = (
  ...
  bindings = [
    ( name = "SERVICE_BINDING", service = ( name = "service-binding" ))
  ],
  compatibilityDate = "2025-04-01",
  compatibilityFlags = ["nodejs_compat", "nodejs_compat_populate_process_env"]
);

const serviceBinding :Workerd.Worker = (
  modules = [
    (name = "serviceBinding", esModule = embed "service-binding.js")
  ],
  compatibilityDate = "2025-04-01",
);
