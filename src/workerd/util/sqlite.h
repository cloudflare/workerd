...
class SqliteObserver {
 public:
  ...
  virtual void reportQueryEvent(kj::Maybe<kj::StringPtr> queryStatement,
      ...
      kj::Maybe<kj::StringPtr> queryErrorDescription) {}
  ...
  class QueryEvent {
   public:
    ...
    ~QueryEvent() {
      ...
      observer.reportQueryEvent(queryStatement, rowsRead, rowsWritten, queryLatency,
          dbWalBytesWritten, queryResult, isInternalQuery, queryErrorDescription);
    }
    ...
    void setQueryStatement(kj::StringPtr queryStatement) {
      this->queryStatement = queryStatement;
    }

    void setQueryErrorDescription(kj::StringPtr queryErrorDescription) {
      this->queryErrorDescription = queryErrorDescription;
    }
   ...
   private:
    ...
    kj::Maybe<kj::StringPtr> queryStatement = kj::none;
    bool isInternalQuery;
    ...
    int queryResult = 0;
    kj::Maybe<kj::StringPtr> queryErrorDescription = kj::none;
  };
