...
class StructuredLoggingProcessContext final: public kj::ProcessContext {
 ...
 public:
  ...
  // When enabled: Log messages are formatted as JSON and sent to stdout
  // When disabled: Log messages are sent as plain text to stderr (like TopLevelProcessContext)
