...
class InnerEgressService final: public kj::HttpService {
 public:
  using ChannelLookup =
      kj::Function<kj::Maybe<kj::Own<IoChannelFactory::SubrequestChannel>>()>;
  ...
  kj::Promise<void> request(kj::HttpMethod method,
    ...
    auto channel = KJ_REQUIRE_NONNULL(lookupChannel(),
        "egress mapping disappeared during active tunnel");
...
kj::Maybe<kj::Own<workerd::IoChannelFactory::SubrequestChannel>>
ContainerClient::findEgressMapping(kj::StringPtr destAddr, uint16_t defaultPort) {
