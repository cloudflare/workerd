...
public:
  ...
  void enableInspector(kj::OneOf<kj::Own<kj::ConnectionReceiver>, kj::String> fdOrAddr) {
    inspectorOverride = kj::mv(fdOrAddr);
  }
...
private:
  ...
  kj::Maybe<kj::OneOf<kj::Own<kj::ConnectionReceiver>, kj::String>> inspectorOverride;
  ...
  KJ_DECLARE_NON_POLYMORPHIC(InspectorService);
