...
#undef EW_TYPE_GROUP_WRITE
    ...
    // Require explicit `nodejs_compat` flag to include RTTI for internal Node compat modules
    registerModules(registry, flags, node::NodeJsCompatAccess::REQUIRE_FLAG_FOR_ALL);
