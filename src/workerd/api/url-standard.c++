...
kj::ArrayPtr<const char> URL::getProtocol() { return inner.getProtocol(); }

void URL::setProtocol(kj::String value) { inner.setProtocol(value); }

kj::ArrayPtr<const char> URL::getUsername() { return inner.getUsername(); }

void URL::setUsername(kj::String value) { inner.setUsername(value); }

kj::ArrayPtr<const char> URL::getPassword() { return inner.getPassword(); }

void URL::setPassword(kj::String value) { inner.setPassword(value); }

kj::ArrayPtr<const char> URL::getHost() { return inner.getHost(); }

void URL::setHost(kj::String value) { inner.setHost(value); }

kj::ArrayPtr<const char> URL::getHostname() { return inner.getHostname(); }

void URL::setHostname(kj::String value) { inner.setHostname(value); }

kj::ArrayPtr<const char> URL::getPort() { return inner.getPort(); }

void URL::setPort(kj::String value) { inner.setPort(kj::Maybe(value.asPtr())); }

kj::ArrayPtr<const char> URL::getPathname() { return inner.getPathname(); }

void URL::setPathname(kj::String value) { inner.setPathname(value); }

kj::ArrayPtr<const char> URL::getSearch() { return inner.getSearch(); }
...
kj::ArrayPtr<const char> URL::getHash() { return inner.getHash(); }

void URL::setHash(kj::String hash) { inner.setHash(kj::Maybe(hash.asPtr())); }
...
jsg::UrlSearchParams initSearchParams(const URLSearchParams::Initializer& init) {
  KJ_SWITCH_ONEOF(init) {
    ...
    KJ_CASE_ONEOF(str, kj::String) {
      return JSG_REQUIRE_NONNULL(jsg::UrlSearchParams::tryParse(str), TypeError,
...
URLSearchParams::URLSearchParams(kj::Maybe<kj::ArrayPtr<const char>> maybeQuery,
                                 URL& url) : inner(initFromSearch(maybeQuery)), maybeUrl(url) {}
...
kj::Maybe<kj::Array<kj::ArrayPtr<const char>>> URLSearchParams::entryIteratorNext(
    jsg::Lock& js,
    URLSearchParams::IteratorState<jsg::UrlSearchParams::EntryIterator>& state) {
...
kj::Maybe<kj::ArrayPtr<const char>> URLSearchParams::keyIteratorNext(
    jsg::Lock& js,
    URLSearchParams::IteratorState<jsg::UrlSearchParams::KeyIterator>& state) {
  return state.inner.next();
}

kj::Maybe<kj::ArrayPtr<const char>> URLSearchParams::valueIteratorNext(
    jsg::Lock& js,
    URLSearchParams::IteratorState<jsg::UrlSearchParams::ValueIterator>& state) {
  return state.inner.next();
}
...
void URLSearchParams::forEach(
  ...
  while (entries.hasNext()) {
    ...
    kj::String value(const_cast<char*>(next.value.begin()),
                     next.value.size(),
                     kj::NullArrayDisposer::instance);
    kj::String key(const_cast<char*>(next.key.begin()),
                     next.key.size(),
                     kj::NullArrayDisposer::instance);
