...
jsg::Promise<void> Container::interceptOutboundHttp(jsg::Lock& js, kj::String addr, jsg::Ref<Fetcher> binding) {
...
jsg::Promise<void> Container::interceptAllOutboundHttp(jsg::Lock& js, jsg::Ref<Fetcher> binding) {
  ...
  return ioctx.awaitIo(js, kj::joinPromises(kj::arr(
      reqV4.sendIgnoringResult(),
      reqV6.sendIgnoringResult()
  )));
}
