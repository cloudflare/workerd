...
export const test = {
  async test() {
    ...
    let expected = [
      ...
      '{"type":"onset","executionModel":"durableObject","entrypoint":"MyActor","scriptTags":[],"info":{"type":"jsrpc","methodName":"functionProperty"}}{"type":"log","level":"log","message":["baz"]}{"type":"outcome","outcome":"ok","cpuTime":0,"wallTime":0}',
    ];
