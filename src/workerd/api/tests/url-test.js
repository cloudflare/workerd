  ...
  test() {
    const cases = {
      protocol: [
        ...
        {
          comment:
            'Can’t switch from URL containing username/password/port to file',
      ...
      pathname: [
        ...
        },
        {
          ...
          expected: {
            ...
            pathname:
              "/%00%01%1F%20!%22%23$%&'()*+,-./09:;%3C=%3E%3F@AZ[\\]^_%60az%7B|%7D~%7F%C2%80%C2%81%C3%89%C3%A9",
          },
        },
        {
          comment:
      ...
      hash: [
        ...
        {
          comment:
            'Simple percent-encoding; nuls, tabs, and newlines are removed',
          href: 'a:/',
          new_value:
            '\u0000\u0001\t\n\r\u001f !"#$%&\'()*+,-./09:;<=>?@AZ[\\]^_`az{|}~\u007f\u0080\u0081Éé',
          expected: {
...
export const urlPatternMdn2 = {
  test() {
    ...
    strictEqual(
      pattern.exec('https://example.com/books/123').pathname.groups.id,
      '123'
    );
  },
};
...
export const urlPatternMdn6 = {
  test() {
    ...
    strictEqual(
      pattern.exec('https://example.com/books/123').pathname.groups['0'],
      '123'
    );
  },
};
...
export const urlPatternMdn10 = {
  test() {
    ...
    deepStrictEqual(
      Object.keys(pattern.exec('https://example.com/books').pathname.groups),
      []
    );
  },
};
