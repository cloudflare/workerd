...
// - simple-transform: Ported as simpleTransform
// - delay-transform: Ported as delayTransform
// - different-types-transform: Ported as differentTypesTransform
// - sync-error-during-start: Ported as syncErrorDuringStart
// - async-error-during-start: Ported as asyncErrorDuringStart
// - sync-error-during-transform: Ported as syncErrorDuringTransform
// - async-error-during-transform: Ported as asyncErrorDuringTransform
...
//
// - transform-roundtrip: Tests request body → DecompressionStream → TransformStream →
//   IdentityTransformStream pipeline. Requires request.body handling.
//
// - transform-crash: A regression test that iterates over globalThis properties.
//   Very specific edge case, low priority.
// =============================================================================
