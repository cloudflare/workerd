...
const expectedSpans = [
  ...
  },
  {
    ...
    'db.system.name': 'cloudflare-durable-object-sql',
    'db.operation.name': 'list',
    'cloudflare.durable_object.kv.query.projection': 'keys',
    closed: true,
  },
  {
    name: 'durable_object_storage_kv_list',
    'db.system.name': 'cloudflare-durable-object-sql',
    'db.operation.name': 'list',
    'cloudflare.durable_object.kv.query.projection': 'values',
    closed: true,
  },
  {
    name: 'durable_object_storage_kv_list',
    'db.system.name': 'cloudflare-durable-object-sql',
    'db.operation.name': 'list',
    'cloudflare.durable_object.kv.query.projection': 'entries',
    closed: true,
  },
  {
    name: 'durable_object_storage_kv_list',
  ...
  },
  {
    ...
    'db.system.name': 'cloudflare-durable-object-sql',
    'db.operation.name': 'list',
    'cloudflare.durable_object.kv.query.start': 'z',
