  ...
  async test() {
    async function consume(readable) {
      try {
        ...
        throw new Error('Reading should have failed');
      } catch (err) {
...
// - compression-deflate: Ported as compressionDeflate
// - compression-deflate-raw: Ported as compressionDeflateRaw
// - compression-pending-read: Ported as compressionPendingRead
// - compression-cancel-abort: Ported as compressionCancelAbort
// - decompression-error: Ported as decompressionError
// - decompression-error-iteration: Ported as decompressionErrorIteration
// - piped-decompression-bad-data: Ported as pipedDecompressionBadData
// - transformstream-through-compression: Ported as transformStreamThroughCompression
// - request-body-pipethrough: Ported as requestBodyPipethrough
// - transform-roundtrip: Ported as transformRoundtrip
// - compression-pipeline: Ported as compressionPipeline
//
// All tests from compression.ew-test have been fully ported.
// =============================================================================
