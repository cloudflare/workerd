...
const E = {
  ...
  // queue-test.js
  queueTest:
    '{"type":"onset","executionModel":"stateless","spanId":"0000000000000000","scriptTags":[],"info":{"type":"custom"}}{"type":"spanOpen","name":"queue_send","spanId":"0000000000000001"}{"type":"attributes","info":[{"name":"cloudflare.binding.name","value":"QUEUE"},{"name":"cloudflare.binding.type","value":"queue"},{"name":"cloudflare.queue.operation","value":"send"},{"name":"messaging.system","value":"cloudflare.queues"},{"name":"messaging.destination.name","value":"queue-test"},{"name":"messaging.operation.name","value":"send"},{"name":"messaging.operation.type","value":"send"},{"name":"messaging.message.body.size","value":"3"}]}{"type":"spanClose","outcome":"ok"}{"type":"spanOpen","name":"queue_send","spanId":"0000000000000002"}{"type":"attributes","info":[{"name":"cloudflare.binding.name","value":"QUEUE"},{"name":"cloudflare.binding.type","value":"queue"},{"name":"cloudflare.queue.operation","value":"send"},{"name":"messaging.system","value":"cloudflare.queues"},{"name":"messaging.destination.name","value":"queue-test"},{"name":"messaging.operation.name","value":"send"},{"name":"messaging.operation.type","value":"send"},{"name":"messaging.message.body.size","value":"6"}]}{"type":"spanClose","outcome":"ok"}{"type":"spanOpen","name":"queue_send","spanId":"0000000000000003"}{"type":"attributes","info":[{"name":"cloudflare.binding.name","value":"QUEUE"},{"name":"cloudflare.binding.type","value":"queue"},{"name":"cloudflare.queue.operation","value":"send"},{"name":"messaging.system","value":"cloudflare.queues"},{"name":"messaging.destination.name","value":"queue-test"},{"name":"messaging.operation.name","value":"send"},{"name":"messaging.operation.type","value":"send"},{"name":"messaging.message.body.size","value":"7"}]}{"type":"spanClose","outcome":"ok"}{"type":"spanOpen","name":"queue_send","spanId":"0000000000000004"}{"type":"attributes","info":[{"name":"cloudflare.binding.name","value":"QUEUE"},{"name":"cloudflare.binding.type","value":"queue"},{"name":"cloudflare.queue.operation","value":"send"},{"name":"messaging.system","value":"cloudflare.queues"},{"name":"messaging.destination.name","value":"queue-test"},{"name":"messaging.operation.name","value":"send"},{"name":"messaging.operation.type","value":"send"},{"name":"messaging.message.body.size","value":"17"}]}{"type":"spanClose","outcome":"ok"}{"type":"spanOpen","name":"queue_send","spanId":"0000000000000005"}{"type":"attributes","info":[{"name":"cloudflare.binding.name","value":"QUEUE"},{"name":"cloudflare.binding.type","value":"queue"},{"name":"cloudflare.queue.operation","value":"sendBatch"},{"name":"messaging.system","value":"cloudflare.queues"},{"name":"messaging.destination.name","value":"queue-test"},{"name":"messaging.operation.name","value":"send"},{"name":"messaging.operation.type","value":"send"},{"name":"messaging.batch.message_count","value":"4"},{"name":"cloudflare.queue.batch.body.size","value":"31"},{"name":"cloudflare.queue.batch.largest_message.size","value":"13"}]}{"type":"spanClose","outcome":"ok"}{"type":"spanOpen","name":"queue","spanId":"0000000000000006"}{"type":"spanClose","outcome":"ok"}{"type":"outcome","outcome":"ok","cpuTime":0,"wallTime":0}',
  fetchMsgText:
