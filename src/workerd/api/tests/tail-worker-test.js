...
export const test = {
  async test() {
    ...
    let expected = [
      ...
      // Note: Request body size is now in the return event, not the onset event
      '{"type":"onset","executionModel":"stateless","spanId":"0000000000000000","scriptTags":[],"info":{"type":"fetch","method":"POST","url":"http://placeholder/body-length","headers":[]}}{"type":"return","info":{"type":"fetch","statusCode":200,"bodySize":22,"requestBodySize":3}}{"type":"outcome","outcome":"ok","cpuTime":0,"wallTime":0}',
      '{"type":"onset","executionModel":"stateless","spanId":"0000000000000000","scriptTags":[],"info":{"type":"fetch","method":"POST","url":"http://placeholder/body-length","headers":[]}}{"type":"return","info":{"type":"fetch","statusCode":200,"bodySize":31,"requestBodySize":3}}{"type":"outcome","outcome":"ok","cpuTime":0,"wallTime":0}',
      ...
      // Test consume-body endpoint - request body size tracked after body consumed
      '{"type":"onset","executionModel":"stateless","spanId":"0000000000000000","scriptTags":[],"info":{"type":"fetch","method":"POST","url":"http://placeholder/consume-body","headers":[]}}{"type":"return","info":{"type":"fetch","statusCode":200,"bodySize":16,"requestBodySize":5}}{"type":"outcome","outcome":"ok","cpuTime":0,"wallTime":0}',
      // Test streaming-response endpoint - response body size tracked after streaming
      '{"type":"onset","executionModel":"stateless","spanId":"0000000000000000","scriptTags":[],"info":{"type":"fetch","method":"GET","url":"http://placeholder/streaming-response","headers":[]}}{"type":"return","info":{"type":"fetch","statusCode":200,"bodySize":12}}{"type":"outcome","outcome":"ok","cpuTime":0,"wallTime":0}',
