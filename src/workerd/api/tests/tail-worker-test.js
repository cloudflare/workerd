...
const E = {
  ...
  jsrpcExceptionI:
    '{"type":"onset","executionModel":"stateless","spanId":"0000000000000000","entrypoint":"MyService","scriptTags":[],"info":{"type":"jsrpc"}}{"type":"attributes","info":[{"name":"jsrpc.method","value":"neverReturn"}]}{"type":"log","level":"log","message":["bar"]}{"type":"outcome","outcome":"exception","cpuTime":0,"wallTime":0}',
  jsrpcDisposal:
  ...
  jsrpcExceptionIII:
    '{"type":"onset","executionModel":"stateless","spanId":"0000000000000000","entrypoint":"MyService","scriptTags":[],"info":{"type":"jsrpc"}}{"type":"attributes","info":[{"name":"jsrpc.method","value":"leakButReturnPlainObject"}]}{"type":"log","level":"log","message":["bar"]}{"type":"return"}{"type":"outcome","outcome":"exception","cpuTime":0,"wallTime":0}',
  jsrpcTestDispose:
    '{"type":"onset","executionModel":"stateless","spanId":"0000000000000000","entrypoint":"MyService","scriptTags":[],"info":{"type":"jsrpc"}}{"type":"attributes","info":[{"name":"jsrpc.method","value":"testDispose"}]}{"type":"log","level":"log","message":["bar"]}{"type":"return"}{"type":"outcome","outcome":"exception","cpuTime":0,"wallTime":0}',
  jsrpcPortAbortCall:
  ...
  jsrpcExceptionIV:
    '{"type":"onset","executionModel":"durableObject","spanId":"0000000000000000","entrypoint":"MyActor","durableObjectId":"DO_ID","scriptTags":[],"info":{"type":"jsrpc"}}{"type":"log","level":"log","message":["baz"]}{"type":"attributes","info":[{"name":"jsrpc.method","value":"makePostAbortCallTester"}]}{"type":"return"}{"type":"exception","name":"Error","message":"test broken critical section","stack":"    at worker:153:13"}{"type":"outcome","outcome":"exception","cpuTime":0,"wallTime":0}',
  jsrpcExceptionV:
    '{"type":"onset","executionModel":"durableObject","spanId":"0000000000000000","entrypoint":"MyActor","durableObjectId":"DO_ID","scriptTags":[],"info":{"type":"jsrpc"}}{"type":"log","level":"log","message":["baz"]}{"type":"attributes","info":[{"name":"jsrpc.method","value":"makePostAbortCallTester"}]}{"type":"return"}{"type":"outcome","outcome":"exception","cpuTime":0,"wallTime":0}',
...
const expected = [
  ...
  n(E.jsrpcPortAbortCall, [
    n(E.jsrpcExceptionIV),
    n(E.jsrpcExceptionV),
  ]),
