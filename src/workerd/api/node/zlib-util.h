...
public:
  ...
  JSG_RESOURCE_TYPE(ZlibUtil) {
    ...
    JSG_STATIC_CONSTANT_NAMED(CONST_DEFLATE, static_cast<uint8_t>(ZlibMode::DEFLATE));
    JSG_STATIC_CONSTANT_NAMED(CONST_INFLATE, static_cast<uint8_t>(ZlibMode::INFLATE));
    JSG_STATIC_CONSTANT_NAMED(CONST_GZIP, static_cast<uint8_t>(ZlibMode::GZIP));
    JSG_STATIC_CONSTANT_NAMED(CONST_GUNZIP, static_cast<uint8_t>(ZlibMode::GUNZIP));
    JSG_STATIC_CONSTANT_NAMED(CONST_DEFLATERAW, static_cast<uint8_t>(ZlibMode::DEFLATERAW));
    JSG_STATIC_CONSTANT_NAMED(CONST_INFLATERAW, static_cast<uint8_t>(ZlibMode::INFLATERAW));
    JSG_STATIC_CONSTANT_NAMED(CONST_UNZIP, static_cast<uint8_t>(ZlibMode::UNZIP));
    JSG_STATIC_CONSTANT_NAMED(CONST_BROTLI_DECODE, static_cast<uint8_t>(ZlibMode::BROTLI_DECODE));
    JSG_STATIC_CONSTANT_NAMED(CONST_BROTLI_ENCODE, static_cast<uint8_t>(ZlibMode::BROTLI_ENCODE));
