...
class ZlibUtil final: public jsg::Object {
 public:
  ...
  class CompressionStream: public jsg::Object {
   public:
    explicit CompressionStream(ZlibMode _mode, jsg::ExternalMemoryTarget&& externalMemoryTarget)
  ...
  class ZlibStream final: public CompressionStream<ZlibContext> {
   public:
    explicit ZlibStream(ZlibMode mode, jsg::ExternalMemoryTarget&& externalMemoryTarget)
  ...
  class BrotliCompressionStream: public CompressionStream<CompressionContext> {
   public:
    explicit BrotliCompressionStream(
        ZlibMode _mode, jsg::ExternalMemoryTarget&& externalMemoryTarget)
