...
public:
  ...
  struct CreateAsymmetricKeyOptions {
    kj::OneOf<SubtleCrypto::JsonWebKey,
              jsg::V8Ref<v8::String>,
  ...
  jsg::Ref<CryptoKey> createHmacKey(jsg::Lock& js, kj::Array<kj::byte> keyData);

  jsg::Ref<CryptoKey> createSecretKey(jsg::Lock& js,
                                      kj::OneOf<v8::Local<v8::String>, kj::Array<kj::byte>>,
                                      jsg::Optional<kj::String> encoding);

  using AsymmetricKeyData = kj::OneOf<CreateAsymmetricKeyOptions,
                                      jsg::V8Ref<v8::String>,
                                      kj::Array<kj::byte>>;

  jsg::Ref<CryptoKey> createPrivateKey(jsg::Lock& js, AsymmetricKeyData key);
  jsg::Ref<CryptoKey> createPublicKey(jsg::Lock& js, AsymmetricKeyData key);
