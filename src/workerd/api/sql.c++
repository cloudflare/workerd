...
jsg::Ref<SqlStorage::Cursor> SqlStorage::exec(
  ...
  userSpan.setTag("db.system"_kjc, kj::str("cloudflare-durable-object-sql"_kjc));
  userSpan.setTag("db.operation.name"_kjc, kj::str("exec"_kjc));
  userSpan.setTag("cloudflare.durable_object.query.statement"_kjc, kj::str(querySql));
