...
CompressionAllocator::CompressionAllocator(const jsg::ExternalMemoryTarget& externalMemoryTarget)
...
class Context {
 public:
  ...
  explicit Context(Mode mode,
      kj::StringPtr format,
      ContextFlags flags,
      const jsg::ExternalMemoryTarget& externalMemoryTarget)
...
class CompressionStreamImpl: public kj::Refcounted,
 ...
 public:
  explicit CompressionStreamImpl(kj::String format,
      ...
      const jsg::ExternalMemoryTarget& externalMemoryTarget)
      : context(mode, format, flags, externalMemoryTarget) {}
