...
jsg::Promise<R2Bucket::UploadedPart> R2Bucket::uploadPart(jsg::Lock& js,
  ...
  return js.evalNow([&] {
    ...
    auto& context = IoContext::current();
    auto client = context.getHttpClient(clientIndex, true, nullptr, "r2_uploadPart"_kj);
...
jsg::Promise<void> R2Bucket::abortMultipartUpload(jsg::Lock& js, kj::String key, kj::String uploadId,
    const jsg::TypeHandler<jsg::Ref<R2Error>>& errorType) {
  return js.evalNow([&] {
    auto& context = IoContext::current();
    auto client = context.getHttpClient(clientIndex, true, nullptr, "r2_abortMultipartUpload"_kj);
...
jsg::Promise<jsg::Ref<R2Bucket::HeadResult>> R2Bucket::completeMultipartUpload(jsg::Lock& js, kj::String key, kj::String uploadId,
    kj::Array<R2Bucket::UploadedPart> uploadedParts, const jsg::TypeHandler<jsg::Ref<R2Error>>& errorType) {
  return js.evalNow([&] {
    auto& context = IoContext::current();
    auto client = context.getHttpClient(clientIndex, true, nullptr, "r2_completeMultipartUpload"_kj);
    ...
    return context.awaitIo(js, kj::mv(promise),
        [&errorType]
        (jsg::Lock& js, R2Result r2Result) mutable {
      auto parsedObject = parseObjectMetadata<HeadResult>("completeMultipartUpload", r2Result, errorType);
