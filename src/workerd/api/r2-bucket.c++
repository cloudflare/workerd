...
void initOnlyIf(TraceContext& traceContext, jsg::Lock& js, Builder& builder, Options& o) {
  KJ_IF_SOME(i, o.onlyIf) {
    ...
    KJ_IF_SOME(d, c.uploadedBefore) {
      ...
      traceContext.userSpan.setTag(
          "cloudflare.r2.request.only_if.uploaded_before"_kjc, toISOString(js, d));
    }
    KJ_IF_SOME(d, c.uploadedAfter) {
      ...
      traceContext.userSpan.setTag(
          "cloudflare.r2.request.only_if.uploaded_after"_kjc, toISOString(js, d));
    }
  }
}
...
void addHeadResultSpanTags(
  ...
  traceContext.userSpan.setTag(
      "cloudflare.r2.response.storage_class"_kjc, headResult.getStorageClass());
  ...
  KJ_IF_SOME(httpMetadata, headResult.getHttpMetadata()) {
    KJ_IF_SOME(ct, httpMetadata.contentType) {
      traceContext.userSpan.setTag("cloudflare.r2.response.content_type"_kjc, ct.asPtr());
    }
    KJ_IF_SOME(ce, httpMetadata.contentEncoding) {
      traceContext.userSpan.setTag("cloudflare.r2.response.content_encoding"_kjc, ce.asPtr());
    }
    KJ_IF_SOME(cd, httpMetadata.contentDisposition) {
      traceContext.userSpan.setTag("cloudflare.r2.response.content_disposition"_kjc, cd.asPtr());
    }
    KJ_IF_SOME(cl, httpMetadata.contentLanguage) {
      traceContext.userSpan.setTag("cloudflare.r2.response.content_language"_kjc, cl.asPtr());
    }
    KJ_IF_SOME(cc, httpMetadata.cacheControl) {
      traceContext.userSpan.setTag("cloudflare.r2.response.cache_control"_kjc, cc.asPtr());
    }
    KJ_IF_SOME(ce, httpMetadata.cacheExpiry) {
      traceContext.userSpan.setTag("cloudflare.r2.response.cache_expiry"_kjc, toISOString(js, ce));
    }
  }
    ...
    KJ_SWITCH_ONEOF(range) {
      ...
      KJ_CASE_ONEOF(h, jsg::Ref<Headers>) {
        KJ_IF_SOME(e, h->getCommon(js, capnp::CommonHeaderName::RANGE)) {
          ...
          traceContext.userSpan.setTag("cloudflare.r2.request.range"_kjc, e.asPtr());
        }
      }
    }
  }
...
jsg::Promise<kj::Maybe<jsg::Ref<R2Bucket::HeadResult>>> R2Bucket::head(jsg::Lock& js,
  ...
  return js.evalNow([&] {
    ...
    traceContext.userSpan.setTag("cloudflare.r2.operation"_kjc, "HeadObject"_kjc);
...
R2Bucket::get(jsg::Lock& js,
  ...
  return js.evalNow([&] {
    ...
    traceContext.userSpan.setTag("cloudflare.r2.operation"_kjc, "GetObject"_kjc);
    KJ_IF_SOME(b, this->bucketName()) {
      traceContext.userSpan.setTag("cloudflare.r2.bucket"_kjc, b);
    }
    traceContext.userSpan.setTag("cloudflare.r2.request.key"_kjc, key.asPtr());
...
jsg::Promise<kj::Maybe<jsg::Ref<R2Bucket::HeadResult>>> R2Bucket::put(jsg::Lock& js,
  ...
  return js.evalNow([&] {
    ...
    traceContext.userSpan.setTag("cloudflare.r2.operation"_kjc, "PutObject"_kjc);
    KJ_IF_SOME(b, this->bucketName()) {
      traceContext.userSpan.setTag("cloudflare.r2.bucket"_kjc, b);
    }
    traceContext.userSpan.setTag("cloudflare.r2.request.key"_kjc, key.asPtr());
    ...
    KJ_IF_SOME(o, options) {
      ...
      KJ_IF_SOME(m, o.customMetadata) {
        ...
        traceContext.userSpan.setTag("cloudflare.r2.request.custom_metadata"_kjc, true);
      }
      KJ_IF_SOME(m, o.httpMetadata) {
        ...
        KJ_IF_SOME(ct, sentHttpMetadata.contentType) {
          ...
          traceContext.userSpan.setTag(
              "cloudflare.r2.request.http_metadata.content_type"_kjc, ct.asPtr());
        }
        ...
        KJ_IF_SOME(cc, sentHttpMetadata.cacheControl) {
          ...
          traceContext.userSpan.setTag(
              "cloudflare.r2.request.http_metadata.cache_control"_kjc, cc.asPtr());
        }
        KJ_IF_SOME(ce, sentHttpMetadata.cacheExpiry) {
          fields.setCacheExpiry((ce - kj::UNIX_EPOCH) / kj::MILLISECONDS);
          traceContext.userSpan.setTag("cloudflare.r2.request.http_metadata.cache_expiry"_kjc,
      ...
      KJ_IF_SOME(md5, o.md5) {
        ...
        KJ_SWITCH_ONEOF(md5) {
          KJ_CASE_ONEOF(bin, jsg::BufferSource) {
            ...
            traceContext.userSpan.setTag("cloudflare.r2.request.checksum.type"_kjc, "md5"_kjc);
            traceContext.userSpan.setTag(
          ...
          KJ_CASE_ONEOF(hex, jsg::NonCoercible<kj::String>) {
            ...
            traceContext.userSpan.setTag("cloudflare.r2.request.checksum.type"_kjc, "md5"_kjc);
            traceContext.userSpan.setTag(
                "cloudflare.r2.request.checksum.value"_kjc, hex.value.asPtr());
          }
        }
      }
      KJ_IF_SOME(sha1, o.sha1) {
        ...
        KJ_SWITCH_ONEOF(sha1) {
          KJ_CASE_ONEOF(bin, jsg::BufferSource) {
            ...
            traceContext.userSpan.setTag("cloudflare.r2.request.checksum.type"_kjc, "sha1"_kjc);
            traceContext.userSpan.setTag(
                "cloudflare.r2.request.checksum.value"_kjc, kj::encodeHex(bin.asArrayPtr()));
          }
          KJ_CASE_ONEOF(hex, jsg::NonCoercible<kj::String>) {
      ...
      KJ_IF_SOME(sha256, o.sha256) {
        ...
        KJ_SWITCH_ONEOF(sha256) {
          KJ_CASE_ONEOF(bin, jsg::BufferSource) {
            ...
            traceContext.userSpan.setTag("cloudflare.r2.request.checksum.type"_kjc, "sha256"_kjc);
            traceContext.userSpan.setTag(
                "cloudflare.r2.request.checksum.value"_kjc, kj::encodeHex(bin.asArrayPtr()));
          }
          KJ_CASE_ONEOF(hex, jsg::NonCoercible<kj::String>) {
      ...
      KJ_IF_SOME(sha384, o.sha384) {
        ...
        KJ_SWITCH_ONEOF(sha384) {
          KJ_CASE_ONEOF(bin, jsg::BufferSource) {
            ...
            traceContext.userSpan.setTag("cloudflare.r2.request.checksum.type"_kjc, "sha384"_kjc);
            traceContext.userSpan.setTag(
                "cloudflare.r2.request.checksum.value"_kjc, kj::encodeHex(bin.asArrayPtr()));
          }
          KJ_CASE_ONEOF(hex, jsg::NonCoercible<kj::String>) {
      ...
      KJ_IF_SOME(sha512, o.sha512) {
        ...
        KJ_SWITCH_ONEOF(sha512) {
          KJ_CASE_ONEOF(bin, jsg::BufferSource) {
            ...
            traceContext.userSpan.setTag("cloudflare.r2.request.checksum.type"_kjc, "sha512"_kjc);
            traceContext.userSpan.setTag(
                "cloudflare.r2.request.checksum.value"_kjc, kj::encodeHex(bin.asArrayPtr()));
          }
          KJ_CASE_ONEOF(hex, jsg::NonCoercible<kj::String>) {
      ...
      KJ_IF_SOME(s, o.storageClass) {
        ...
        traceContext.userSpan.setTag("cloudflare.r2.request.storage_class"_kjc, s.asPtr());
      }
      kj::Maybe<kj::String> maybeSsecKey = buildSsecKey(kj::mv(o.ssecKey));
      KJ_IF_SOME(ssecKey, maybeSsecKey) {
...
jsg::Promise<kj::Maybe<jsg::Ref<R2Bucket::HeadResult>>> R2Bucket::copy(jsg::Lock& js,
  ...
  return js.evalNow([&] {
    ...
    auto traceSpan = context.makeTraceSpan("r2_copyObject"_kjc);
    auto userSpan = context.makeUserTraceSpan("r2_copyObject"_kjc);
    TraceContext traceContext(kj::mv(traceSpan), kj::mv(userSpan));
    auto client = context.getHttpClient(clientIndex, true, kj::none, traceContext);
    ...
    traceContext.userSpan.setTag("cloudflare.r2.operation"_kjc, "CopyObject"_kjc);
    KJ_IF_SOME(b, this->bucketName()) {
      traceContext.userSpan.setTag("cloudflare.r2.bucket"_kjc, b);
    }
    traceContext.userSpan.setTag("cloudflare.r2.request.key"_kjc, key.asPtr());
    ...
    // Handle source conditional inline with source-specific tracing tags
    ...
    KJ_IF_SOME(ssecKey, source.ssecKey) {
      ...
      KJ_IF_SOME(ssecKeyStr, maybeSsecKey) {
        auto ssecBuilder = sourceBuilder.initSsec();
        ssecBuilder.setKey(ssecKeyStr);
    ...
    KJ_IF_SOME(o, options) {
      KJ_IF_SOME(metadataDirective, o.metadataDirective) {
        if (metadataDirective == "COPY" || metadataDirective == "REPLACE" ||
          ...
          traceContext.userSpan.setTag(
              "cloudflare.r2.request.metadata_directive"_kjc, metadataDirective.asPtr());
        } else {
          JSG_FAIL_REQUIRE(RangeError, "Unsupported metadata directive value ", metadataDirective);
        }
      }
      initOnlyIf(traceContext, js, copyBuilder, o);
      KJ_IF_SOME(m, o.customMetadata) {
        auto fields = copyBuilder.initCustomFields(m.fields.size());
        for (size_t i = 0; i < m.fields.size(); i++) {
          fields[i].setK(m.fields[i].name);
          fields[i].setV(m.fields[i].value);
        }
      ...
      KJ_IF_SOME(m, o.httpMetadata) {
        auto fields = copyBuilder.initHttpFields();
        sentHttpMetadata = [&]() {
          KJ_SWITCH_ONEOF(m) {
            KJ_CASE_ONEOF(m, HttpMetadata) {
              return kj::mv(m);
      ...
      kj::Maybe<kj::String> maybeSsecKey = buildSsecKey(kj::mv(o.ssecKey));
      KJ_IF_SOME(ssecKey, maybeSsecKey) {
        auto ssecBuilder = copyBuilder.initSsec();
        ssecBuilder.setKey(ssecKey);
        traceContext.userSpan.setTag("cloudflare.r2.request.ssec_key"_kjc, true);
      }
    }
    ...
    return context.awaitIo(js, kj::mv(promise),
      ...
      if (r2Result.preconditionFailed()) {
        ...
        auto result = parseObjectMetadata<HeadResult>(js, "copy", r2Result, errorType);
        KJ_IF_SOME(o, result) {
          o.get()->httpMetadata = kj::mv(sentHttpMetadata);
          o.get()->customMetadata = kj::mv(sentCustomMetadata);
          addHeadResultSpanTags(js, traceContext, *o.get());
...
jsg::Promise<jsg::Ref<R2MultipartUpload>> R2Bucket::createMultipartUpload(jsg::Lock& js,
  ...
  return js.evalNow([&] {
    ...
    traceContext.userSpan.setTag("cloudflare.r2.operation"_kjc, "CreateMultipartUpload"_kjc);
    KJ_IF_SOME(b, this->bucketName()) {
      traceContext.userSpan.setTag("cloudflare.r2.bucket"_kjc, b);
    }
    traceContext.userSpan.setTag("cloudflare.r2.request.key"_kjc, key.asPtr());
    ...
    return context.awaitIo(js, kj::mv(promise),
      ...
      traceContext.userSpan.setTag("cloudflare.r2.response.upload_id"_kjc, uploadId);
...
jsg::Promise<void> R2Bucket::delete_(jsg::Lock& js,
  ...
  return js.evalNow([&] {
    ...
    traceContext.userSpan.setTag("cloudflare.r2.operation"_kjc, "DeleteObject"_kjc);
    KJ_IF_SOME(b, this->bucketName()) {
      traceContext.userSpan.setTag("cloudflare.r2.bucket"_kjc, b);
    }
    ...
    KJ_SWITCH_ONEOF(keys) {
      KJ_CASE_ONEOF(ks, kj::Array<kj::String>) {
        ...
        traceContext.userSpan.setTag("cloudflare.r2.request.keys"_kjc, kj::str(ks));
      }
      KJ_CASE_ONEOF(k, kj::String) {
        deleteBuilder.setObject(k);
        traceContext.userSpan.setTag("cloudflare.r2.request.keys"_kjc, k.asPtr());
      }
    }
...
jsg::Promise<R2Bucket::ListResult> R2Bucket::list(jsg::Lock& js,
  ...
  return js.evalNow([&] {
    ...
    traceContext.userSpan.setTag("cloudflare.r2.operation"_kjc, "ListObjects"_kjc);
    KJ_IF_SOME(b, this->bucketName()) {
      traceContext.userSpan.setTag("cloudflare.r2.bucket"_kjc, b);
    }
    ...
    KJ_IF_SOME(o, options) {
      ...
      KJ_IF_SOME(d, o.startAfter) {
        ...
        traceContext.userSpan.setTag("cloudflare.r2.request.start_after"_kjc, d.value.asPtr());
      }
      KJ_IF_SOME(i, o.include) {
        ...
        for (const auto& reqField: i) {
          if (reqField.value == "httpMetadata") {
            traceContext.userSpan.setTag("cloudflare.r2.request.include.http_metadata"_kjc, true);
          } else if (reqField.value == "customMetadata") {
            traceContext.userSpan.setTag("cloudflare.r2.request.include.custom_metadata"_kjc, true);
          }
        }
