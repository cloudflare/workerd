...
public:
  explicit GPUSupportedLimits(wgpu::SupportedLimits limits)
      : limits_(kj::mv(limits)){};
  JSG_RESOURCE_TYPE(GPUSupportedLimits) {
    JSG_READONLY_PROTOTYPE_PROPERTY(maxTextureDimension1D,
                                    getMaxTextureDimension1D);
    JSG_READONLY_PROTOTYPE_PROPERTY(maxTextureDimension2D,
                                    getMaxTextureDimension2D);
    JSG_READONLY_PROTOTYPE_PROPERTY(maxTextureDimension3D,
                                    getMaxTextureDimension3D);
    JSG_READONLY_PROTOTYPE_PROPERTY(maxTextureArrayLayers,
                                    getMaxTextureArrayLayers);
    JSG_READONLY_PROTOTYPE_PROPERTY(maxBindGroups, getMaxBindGroups);
    JSG_READONLY_PROTOTYPE_PROPERTY(maxBindingsPerBindGroup,
    ...
    JSG_READONLY_PROTOTYPE_PROPERTY(maxSamplersPerShaderStage,
    ...
    JSG_READONLY_PROTOTYPE_PROPERTY(maxUniformBufferBindingSize,
                                    getMaxUniformBufferBindingSize);
    JSG_READONLY_PROTOTYPE_PROPERTY(maxStorageBufferBindingSize,
    ...
    JSG_READONLY_PROTOTYPE_PROPERTY(maxVertexAttributes,
                                    getMaxVertexAttributes);
    JSG_READONLY_PROTOTYPE_PROPERTY(maxVertexBufferArrayStride,
    ...
    JSG_READONLY_PROTOTYPE_PROPERTY(maxInterStageShaderVariables,
                                    getMaxInterStageShaderVariables);
    JSG_READONLY_PROTOTYPE_PROPERTY(maxColorAttachments,
    ...
    JSG_READONLY_PROTOTYPE_PROPERTY(maxComputeWorkgroupSizeX,
                                    getMaxComputeWorkgroupSizeX);
    JSG_READONLY_PROTOTYPE_PROPERTY(maxComputeWorkgroupSizeY,
                                    getMaxComputeWorkgroupSizeY);
    JSG_READONLY_PROTOTYPE_PROPERTY(maxComputeWorkgroupSizeZ,
...
private:
  ...
  uint32_t getMaxBindGroups() { return limits_.limits.maxBindGroups; }
  ...
  uint32_t getMaxVertexBuffers() { return limits_.limits.maxVertexBuffers; }

  uint64_t getMaxBufferSize() { return limits_.limits.maxBufferSize; }
