...
// efficiency.
constexpr kj::StringPtr COMMON_HEADER_NAMES[] = {
  nullptr,  // 0: invalid
  "accept-charset"_kj,
  "accept-encoding"_kj,
  "accept-language"_kj,
  "accept-ranges"_kj,
  "accept"_kj,
  "access-control-allow-origin"_kj,
  "age"_kj,
  "allow"_kj,
  "authorization"_kj,
  "cache-control"_kj,
  "content-disposition"_kj,
  "content-encoding"_kj,
  "content-language"_kj,
  "content-length"_kj,
  "content-location"_kj,
  "content-range"_kj,
  "content-type"_kj,
  "cookie"_kj,
  "date"_kj,
  ...
  "host"_kj,
  "if-match"_kj,
  "if-modified-since"_kj,
  "if-none-match"_kj,
  "if-range"_kj,
  "if-unmodified-since"_kj,
  "last-modified"_kj,
  "link"_kj,
  "location"_kj,
  "max-forwards"_kj,
  "proxy-authenticate"_kj,
  "proxy-authorization"_kj,
  "range"_kj,
  "referer"_kj,
  "refresh"_kj,
  "retry-after"_kj,
  "server"_kj,
  "set-cookie"_kj,
  "strict-transport-security"_kj,
  "transfer-encoding"_kj,
  "user-agent"_kj,
  "vary"_kj,
  "via"_kj,
  "www-authenticate"_kj,
};
...
// The CASE_CONVERSION_TABLE maps latin-1 characters to their case conversion offset. For example, 'A' (0x41) maps to 32, which is the offset to convert it to 'a' (0x61). This allows us to perform
