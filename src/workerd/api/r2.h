...
#define EW_R2_PUBLIC_BETA_ISOLATE_TYPES                                                            \
  api::R2Error, api::public_beta::R2Bucket, api::public_beta::R2MultipartUpload,                   \
      ...
      api::public_beta::R2Bucket::PutOptions, api::public_beta::R2Bucket::CopySource,              \
      api::public_beta::R2Bucket::CopyOptions, api::public_beta::R2Bucket::MultipartOptions,       \
      ...
      api::public_beta::R2MultipartUpload::UploadPartCopySource,                                   \
      api::public_beta::R2MultipartUpload::UploadPartCopyOptions
