...
class ExternalMemoryTarget final {
 public:
  ExternalMemoryTarget(v8::ExternalMemoryAccounter& externalMemoryAccounter, v8::Isolate* isolate);

  ExternalMemoryAdjustment getAdjustment(int64_t amount = 0);
