...
// Utility method currently only used in resource.h to resolve lazy properties
// exported by a given module. Defined here to avoid a circular dependency of
// header imports. See modules.c++ for the implementation.
