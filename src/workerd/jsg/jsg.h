...
class ExternalMemoryPtr: public kj::Refcounted {
  struct Impl;

 public:
  ExternalMemoryPtr(): maybeInner(kj::none) {}

  ExternalMemoryPtr(v8::Isolate* isolate, v8::ExternalMemoryAccounter* accounter) {
 ...
 private:
  kj::Own<ExternalMemoryPtr> addRef();
  void reset();
...
using ExternalMemoryTarget = kj::Own<ExternalMemoryPtr>;
...
class ExternalMemoryAdjustment final {
 public:
  ExternalMemoryAdjustment(kj::Own<ExternalMemoryPtr> externalMemory, size_t amount);
 ...
 private:
  kj::Own<ExternalMemoryPtr> externalMemory;
  size_t amount = 0;
...
class Lock {
 public:
  ...
  // getAdjustment() can be invoked at any time to create a new RAII adjustment object
  // pointing to this isolate
  ExternalMemoryTarget getExternalMemoryTarget();
