...
// * MutableSnapshot: a zygote isolate built via v8::SnapshotCreator; holds a mutable borrow of
//   the artifact and fills it during IsolateBase::prepareSnapshot(). The isolate's creator owns
//   the artifact.
