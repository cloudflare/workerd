...
// This method never has access to *this* of the parent class. It is available as a convenience
// method for existing Rust methods (which are C methods) to interact and register to JSG.
