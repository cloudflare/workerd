...
#define JSG_IF_NONEMPTY_(dummy, part1, part2, part3, part4, \
                                 part5, part6, part7, part8, result, ...) JSG_EXPAND result
...
#define JSG_IF_NONEMPTY(arg, ...) \
  JSG_IF_NONEMPTY_3_(JSG_IF_NONEMPTY_2_(arg), \
