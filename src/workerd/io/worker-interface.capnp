...
interface TailStreamTarget $Cxx.allowCancellation {
  ...
  struct TailStreamResults {
    ...
    # completed trace object. This will be empty except when we're using the legacy tail worker via
    # RPC.
  }
...
interface EventDispatcher @0xf20697475ec1752d {
  ...
  tailStreamSession @10 (isFirst :Bool) -> (topLevel :TailStreamTarget) $Cxx.allowCancellation;
