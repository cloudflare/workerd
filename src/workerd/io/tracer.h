...
class WorkerTracer final: public BaseTracer {
 public:
  ...
  // Variant for when we don't have a proper IoContext but instead provide context, the span the
  // onset is parented on, and timestamp directly, used internally for RPC-based tracing.
