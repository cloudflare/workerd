...
class RequestTracker final: public kj::Refcounted, public kj::RcAddRefToThis<RequestTracker> {
public:
  class Hooks {
  public:
  ...
  public:
    ...
    ActiveRequest(kj::Badge<RequestTracker>, kj::Rc<RequestTracker> parent);
