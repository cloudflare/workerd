...
struct TestFixture {
  struct SetupParams {
    ...
    // If set, called to create the actor's ActorObserver instead of the no-op base implementation.
    kj::Maybe<kj::Function<kj::Own<ActorObserver>()>> actorObserverFactory;
