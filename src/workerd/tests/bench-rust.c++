...
JSG_DECLARE_ISOLATE_TYPE(FastMethodIsolate, RustContext, workerd::rust::dns::CaaRecord);
...
BENCHMARK_F(FastMethodFixture, CPP)(benchmark::State& state) {
...
BENCHMARK_F(FastMethodFixture, RUST)(benchmark::State& state) {
  FastMethodIsolate isolate(system, kj::heap<jsg::IsolateObserver>(), {});
  auto code =
