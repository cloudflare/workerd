...
struct MockIsolateLimitEnforcer final: public IsolateLimitEnforcer {
  ...
  kj::Own<void> enterStartupJs(jsg::Lock& lock, kj::Maybe<kj::Exception>& error) const override {
    return {};
  }
  ...
  kj::Own<void> enterLoggingJs(jsg::Lock& lock, kj::Maybe<kj::Exception>& error) const override {
    return {};
  }
  kj::Own<void> enterInspectorJs(jsg::Lock& loc, kj::Maybe<kj::Exception>& error) const override {
    return {};
  }
...
PythonConfig defaultPythonConfig{
  .diskCacheRoot = kj::none, .createSnapshot = false, .createBaselineSnapshot = false};
