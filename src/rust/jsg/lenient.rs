...
/// instead of erroring. When `T::try_from_js` reports a shallow conversion mismatch, the
/// original JS value is preserved as [`Lenient::Unconvertable`] rather than propagating the error.
