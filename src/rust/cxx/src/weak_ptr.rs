...
use crate::shared_ptr::SharedPtrTarget;
    ...
    T: WeakPtrTarget,
{
    ...
    pub fn null() -> Self {
        let mut weak_ptr = MaybeUninit::<Self>::uninit();
...
// Safety: the target's Send and Sync bounds make weak ownership safe across threads.
