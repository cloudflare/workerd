...
pub fn write(out: &mut OutFile) {
    ...
    if !cxx_header {
        ifndef::write(out, builtin.panic.then_some(()), "CXXBRIDGE1_PANIC");
        ...
        ifndef::write(
            out,
            builtin.rust_string.then_some(()),
            "CXXBRIDGE1_RUST_STRING",
        );
        ifndef::write(out, builtin.rust_str.then_some(()), "CXXBRIDGE1_RUST_STR");
        ifndef::write(
            out,
            builtin.rust_slice.then_some(()),
            "CXXBRIDGE1_RUST_SLICE",
        );
        ifndef::write(out, builtin.rust_box.then_some(()), "CXXBRIDGE1_RUST_BOX");
        ifndef::write(
            out,
            builtin.unsafe_bitcopy_t.then_some(()),
            "CXXBRIDGE1_RUST_BITCOPY_T",
        );
        ifndef::write(
            out,
            builtin.unsafe_bitcopy.then_some(()),
            "CXXBRIDGE1_RUST_BITCOPY",
        );
        ifndef::write(out, builtin.rust_vec.then_some(()), "CXXBRIDGE1_RUST_VEC");
        ifndef::write(out, builtin.rust_fn.then_some(()), "CXXBRIDGE1_RUST_FN");
        ifndef::write(
            out,
            builtin.rust_isize.then_some(()),
            "CXXBRIDGE1_RUST_ISIZE",
        );
        ifndef::write(out, builtin.opaque.then_some(()), "CXXBRIDGE1_RUST_OPAQUE");
        ifndef::write(
            out,
            builtin.is_complete.then_some(()),
            "CXXBRIDGE1_IS_COMPLETE",
        );
        ifndef::write(out, builtin.layout.then_some(()), "CXXBRIDGE1_LAYOUT");
        ifndef::write(
            out,
            builtin.relocatable.then_some(()),
