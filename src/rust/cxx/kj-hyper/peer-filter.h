...
class HyperPeerFilter {
 public:
  ...
  HyperPeerFilter(): active(kj::arc<kj_rs_io::PeerFilter>()) {}
  ...
  HyperPeerFilter(kj::ArrayPtr<const kj::StringPtr> allow, kj::ArrayPtr<const kj::StringPtr> deny)
      : active(kj::arc<kj_rs_io::PeerFilter>(allow, deny, kj::arc<kj_rs_io::PeerFilter>())) {}
 ...
 private:
  ...
  kj::Arc<kj_rs_io::PeerFilter> active;
