...
from .allow_entropy import allow_bad_entropy_calls, raise_unless_entropy_allowed, get_bad_entropy_flag
...
register_create_patch("tiktoken._tiktoken", rust_package_context)
register_exec_patch("cryptography.exceptions", rust_package_context)
register_exec_patch("jiter", rust_package_context)
