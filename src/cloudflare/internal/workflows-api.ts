...
class InstanceImpl implements WorkflowInstance {
  // Must be a true private field, not TS `private`: that is erased at runtime and would expose
  // the inner fetcher's RPC wildcard as `env.MY_WORKFLOW.fetcher.anything`.
