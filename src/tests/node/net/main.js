...
export {
  ...
  sharedGeneratorBufferReceivesEveryFill,
  rotatingGeneratorBuffersReceiveEveryFill,
  callbackFalseStopsReading,
  generatorThrowDestroysSocket,
  callbackThrowDestroysSocket,
  dataListenerThrowDestroysSocket,
