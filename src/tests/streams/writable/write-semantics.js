...
// startedness model: the C++ sink already ran (sees the original value),
// the TypeScript sink runs later (sees the mutation).
...
// A detached ArrayBuffer is an acceptable chunk: no validation, passed
// through with byteLength 0 (parity).
