...
// The streams_no_default_auto_allocate_chunk_size flag cell (C++ only;
// the TypeScript implementation has this behavior unconditionally —
// see controller.js byobRequestOnDefaultRead). With the flag, pull()
// for a default read sees byobRequest null unless autoAllocateChunkSize
// is set. Migrated from streams-no-auto-allocate-test.js.
