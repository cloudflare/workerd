    ...
    case 'object': {
      ...
      switch (Object.getPrototypeOf(value)) {
        case Object.prototype:
          ...
          for (let prop of Object.values(value)) {
            if (!isJsonSerializable(prop, seen)) return false;
          }
          return true;
        case Array.prototype:
          for (let elem of value) {
            if (!isJsonSerializable(elem, seen)) return false;
          }
          return true;
        default:
          return false;
...
function getInitialEnv() {
  ...
  for (let [key, value] of Object.entries(utilImpl.getEnvObject())) {
    ...
    // intended to be conveyed. This is important becasue, for example, we could extend dynamic
