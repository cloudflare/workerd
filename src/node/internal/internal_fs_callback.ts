...
export function fstat(
  fd: number,
  optionsOrCallback: SingleArgCallback<Stats> | { bigint: boolean },
  callback?: SingleArgCallback<Stats>
): void {
...
export function mkdir(
  ...
  let options: number | MkdirSyncOptions;
  if (typeof optionsOrCallback === 'function') {
    callback = optionsOrCallback;
    options = {};
  } else {
...
export function read(
  ...
  position: undefined | number | bigint | null,
  callback: DoubleArgCallback<number, ArrayBufferView>
): void;
export function read(
  fd: number,
  callback: DoubleArgCallback<number, ArrayBufferView>
...
export function read(
  ...
  bufferOptionsOrCallback:
    | ArrayBufferView
    | ReadSyncOptions
    | DoubleArgCallback<number, ArrayBufferView>,
  offsetOptionsOrCallback?:
    | ReadSyncOptions
    | number
    | DoubleArgCallback<number, ArrayBufferView>,
  lengthOrCallback?: null | number | DoubleArgCallback<number, ArrayBufferView>,
  ...
  let actualCallback: undefined | DoubleArgCallback<number, ArrayBufferView>;
  let actualBuffer: ArrayBufferView; // Buffer, TypedArray, or DataView
  ...
  if (typeof bufferOptionsOrCallback === 'function') {
    ...
    actualBuffer = Buffer.alloc(16384);
...
export function readv(
  fd: number,
  buffers: ArrayBufferView[],
  position: undefined | null | number | bigint,
  callback: DoubleArgCallback<number, ArrayBufferView[]>
): void;
export function readv(
  fd: number,
...
export function rmdir(
  path: FilePath,
  optionsOrCallback: ErrorOnlyCallback | RmdirSyncOptions,
  callback?: ErrorOnlyCallback
): void {
  let options: RmdirSyncOptions;
  if (typeof optionsOrCallback === 'function') {
    callback = optionsOrCallback;
    options = {};
  } else {
...
export function rm(
  path: FilePath,
  options: RmSyncOptions,
  callback: ErrorOnlyCallback
): void;
export function rm(
  path: FilePath,
  optionsOrCallback: ErrorOnlyCallback | RmSyncOptions,
  callback?: ErrorOnlyCallback
): void {
  let options: RmSyncOptions;
  if (typeof optionsOrCallback === 'function') {
    callback = optionsOrCallback;
    options = {};
  } else {
...
export function statfs(
  path: FilePath,
  callback: SingleArgCallback<StatFs>
): void;
export function statfs(
  path: FilePath,
  options: { bigint: boolean },
...
export function statfs(
  path: FilePath,
  optionsOrCallback: SingleArgCallback<StatFs> | { bigint?: boolean },
  callback?: SingleArgCallback<StatFs>
): void {
  let options: { bigint?: boolean };
  if (typeof optionsOrCallback === 'function') {
...
export function write(
  ...
  try {
    ...
    // eslint-disable-next-line @typescript-eslint/no-confusing-void-expression
    queueMicrotask(() => callback(null, written, buffer));
  } catch (err) {
    // eslint-disable-next-line @typescript-eslint/no-confusing-void-expression
    queueMicrotask(() => callback(err));
  }
