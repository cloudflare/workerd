...
export class ClientRequest extends Writable {
  ...
  public path: string;
  public host: string;
  public joinDuplicateHeaders: boolean;
  ...
  public constructor(
    ...
    this.joinDuplicateHeaders = Boolean(options.joinDuplicateHeaders);
