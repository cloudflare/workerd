...
def crate_repositories():
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/cxx/1.0.151/download"],
        strip_prefix = "cxx-1.0.151",
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/cxxbridge-flags/1.0.151/download"],
        strip_prefix = "cxxbridge-flags-1.0.151",
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/cxxbridge-macro/1.0.151/download"],
        strip_prefix = "cxxbridge-macro-1.0.151",
    ...
    maybe(
        http_archive,
        name = "crates_vendor__once_cell-1.21.2",
        sha256 = "c2806eaa3524762875e21c3dcd057bc4b7bfa01ce4da8d46be1cd43649e1cc6b",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/once_cell/1.21.2/download"],
        strip_prefix = "once_cell-1.21.2",
        build_file = Label("@workerd//deps/rust/crates:BUILD.once_cell-1.21.2.bazel"),
    )
