...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "capnp": Label("@crates_vendor//:capnp-0.23.0"),
            "capnp-rpc": Label("@crates_vendor//:capnp-rpc-0.23.0"),
            "capnpc": Label("@crates_vendor//:capnpc-0.23.2"),
            "cc": Label("@crates_vendor//:cc-1.2.48"),
            ...
            "tracing": Label("@crates_vendor//:tracing-0.1.43"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crates_vendor__capnp-0.23.0",
        sha256 = "bbffb6e69e1ea2cf518ac5037a78a223ecb82b4ac81e7ab33cb5211b43d712ac",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/capnp/0.23.0/download"],
        strip_prefix = "capnp-0.23.0",
        build_file = Label("//deps/rust/crates:BUILD.capnp-0.23.0.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__capnp-futures-0.23.0",
        sha256 = "a5ba7ae93ff689252798d8c71274512738ac2f3993da2adc961aa7441d2a27e6",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/capnp-futures/0.23.0/download"],
        strip_prefix = "capnp-futures-0.23.0",
        build_file = Label("//deps/rust/crates:BUILD.capnp-futures-0.23.0.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__capnp-rpc-0.23.0",
        sha256 = "c263a9de8bfe8a151e30f6d32e620483dcdca4ed8fed6913be9bd9803cbd4e5e",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/capnp-rpc/0.23.0/download"],
        strip_prefix = "capnp-rpc-0.23.0",
        build_file = Label("//deps/rust/crates:BUILD.capnp-rpc-0.23.0.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__capnpc-0.23.2",
        sha256 = "3f1cd4f042d6725da6245bde08c9e7c74f6fcb2d8bd5e0378e57991be8d711d8",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/capnpc/0.23.2/download"],
        strip_prefix = "capnpc-0.23.2",
        build_file = Label("//deps/rust/crates:BUILD.capnpc-0.23.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//deps/rust/crates:BUILD.cc-1.2.48.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__find-msvc-tools-0.1.5",
        ...
        build_file = Label("//deps/rust/crates:BUILD.find-msvc-tools-0.1.5.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__tracing-0.1.43",
        ...
        build_file = Label("//deps/rust/crates:BUILD.tracing-0.1.43.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__tracing-core-0.1.35",
        ...
        build_file = Label("//deps/rust/crates:BUILD.tracing-core-0.1.35.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__zerocopy-0.8.30",
        sha256 = "4ea879c944afe8a2b25fef16bb4ba234f47c694565e97383b36f3a878219065c",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/zerocopy/0.8.30/download"],
        strip_prefix = "zerocopy-0.8.30",
        build_file = Label("//deps/rust/crates:BUILD.zerocopy-0.8.30.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__zerocopy-derive-0.8.30",
        sha256 = "cf955aa904d6040f70dc8e9384444cb1030aed272ba3cb09bbc4ab9e7c1f34f5",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/zerocopy-derive/0.8.30/download"],
        strip_prefix = "zerocopy-derive-0.8.30",
        build_file = Label("//deps/rust/crates:BUILD.zerocopy-derive-0.8.30.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "crates_vendor__capnp-0.23.0", is_dev_dep = False),
        struct(repo = "crates_vendor__capnp-rpc-0.23.0", is_dev_dep = False),
        struct(repo = "crates_vendor__capnpc-0.23.2", is_dev_dep = False),
        struct(repo = "crates_vendor__cc-1.2.48", is_dev_dep = False),
        ...
        struct(repo = "crates_vendor__tracing-0.1.43", is_dev_dep = False),
    ]
