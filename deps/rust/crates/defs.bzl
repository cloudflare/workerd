...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "clap": Label("@crates_vendor//:clap-4.5.49"),
            "codespan-reporting": Label("@crates_vendor//:codespan-reporting-0.13.0"),
            "flate2": Label("@crates_vendor//:flate2-1.1.4"),
            ...
            "syn": Label("@crates_vendor//:syn-2.0.107"),
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//deps/rust/crates:BUILD.cc-1.2.41.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__clap-4.5.49",
        sha256 = "f4512b90fa68d3a9932cea5184017c5d200f5921df706d45e853537dea51508f",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/clap/4.5.49/download"],
        strip_prefix = "clap-4.5.49",
        build_file = Label("//deps/rust/crates:BUILD.clap-4.5.49.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__clap_builder-4.5.49",
        sha256 = "0025e98baa12e766c67ba13ff4695a887a1eba19569aad00a472546795bd6730",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/clap_builder/4.5.49/download"],
        strip_prefix = "clap_builder-4.5.49",
        build_file = Label("//deps/rust/crates:BUILD.clap_builder-4.5.49.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__codespan-reporting-0.13.0",
        sha256 = "ba7a06c0b31fff5ff2e1e7d37dbf940864e2a974b336e1a2938d10af6e8fb283",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/codespan-reporting/0.13.0/download"],
        strip_prefix = "codespan-reporting-0.13.0",
        build_file = Label("//deps/rust/crates:BUILD.codespan-reporting-0.13.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__flate2-1.1.4",
        ...
        build_file = Label("//deps/rust/crates:BUILD.flate2-1.1.4.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__syn-2.0.107",
        ...
        build_file = Label("//deps/rust/crates:BUILD.syn-2.0.107.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "crates_vendor__clap-4.5.49", is_dev_dep = False),
        struct(repo = "crates_vendor__codespan-reporting-0.13.0", is_dev_dep = False),
        struct(repo = "crates_vendor__flate2-1.1.4", is_dev_dep = False),
        ...
        struct(repo = "crates_vendor__syn-2.0.107", is_dev_dep = False),
