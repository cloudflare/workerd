...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "serde": Label("@crates_vendor//:serde-1.0.220"),
            "serde_json": Label("@crates_vendor//:serde_json-1.0.144"),
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crates_vendor__serde-1.0.220",
        ...
        build_file = Label("//deps/rust/crates:BUILD.serde-1.0.220.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__serde_core-1.0.220",
        ...
        build_file = Label("//deps/rust/crates:BUILD.serde_core-1.0.220.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__serde_derive-1.0.220",
        ...
        build_file = Label("//deps/rust/crates:BUILD.serde_derive-1.0.220.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__serde_json-1.0.144",
        ...
        build_file = Label("//deps/rust/crates:BUILD.serde_json-1.0.144.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "crates_vendor__serde-1.0.220", is_dev_dep = False),
        struct(repo = "crates_vendor__serde_json-1.0.144", is_dev_dep = False),
