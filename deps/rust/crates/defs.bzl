...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "cc": Label("@crates_vendor//:cc-1.2.46"),
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//deps/rust/crates:BUILD.cc-1.2.46.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "crates_vendor__cc-1.2.46", is_dev_dep = False),
